    ...
    <section className="block justify-center items-center bg-gray-100 py-12 px-4">
      ...
      <div className="grid grid-cols-2 m-5">
        <p className="text-gray-700 leading-relaxed text-xl indent-10">
          Oil spill dispersant spray systems are portable lightweight sets that
          can be quickly and easily mounted on tugs, offshore supply vessels and
          other pollution control craft responding to marine emergency oil spill
          situations. “ We couldn’t believe how much time we have saved by using
          this system, we have never seen pump performance like this on a
          ...
          The above oil spill dispersant spray system consists of a self priming
          positive displacement pump, prime mover, dispersant flowmeter and
          interconnecting pipework, all mounted on an aluminum frame.
        </p>
